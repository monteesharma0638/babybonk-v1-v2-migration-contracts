...
module.exports = async (deployer, network, accounts) => {
	...
	// v1 token logic here
	const babybonkv1Address = "0xBb2826Ab03B6321E170F0558804F2B6488C98775"; // Replace with actual deployed address
	// const babybonkv1 = await BabyBonkV1.at(babybonkv1Address); // Replace with actual deployed address
	...
	const babybonkmigration = await deployer.deploy(
		BabyBonkMigration,
		"0x91849F9df02ADa31d64b4c958Ca025093925E08B",
		"0x91849F9df02ADa31d64b4c958Ca025093925E08B",
	...
	// await addLiquidity(babybonkv2, owner);
}
